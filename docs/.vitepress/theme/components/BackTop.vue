...
.vitepress-backTop-main {
  ...
  height: 44px;
  border-radius: 50%;
  background: linear-gradient(145deg, var(--vp-c-brand-3), var(--vp-c-brand-1));
  padding: 8px;
...
.vitepress-backTop-main:hover {
  background: linear-gradient(145deg, var(--vp-c-brand-2), var(--vp-c-brand-1));
}
...
.progress-ring-background {
  fill: none;
  stroke: color-mix(in srgb, var(--vp-c-brand-1) 18%, transparent);
  stroke-width: 3;
}
