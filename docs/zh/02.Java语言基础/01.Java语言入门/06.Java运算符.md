...
![运算符](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-14-59.svg)
...
![表达式](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-15-02.svg)

* `操作数` 指的是 `参与运算` 的 `值` 或者 `对象`，如下所示：

![操作数](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-15-04.svg)
...
![](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-15-08.jpeg)
...
![与门电路](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-15-20.gif)

* ② 如果将 `开关` 的 `连通` 和 `断开` 称为 `输入端`，而 `灯泡` 的 `连通`（亮）和 `断开`（暗）称为 `输出端`，并将整个电路都封装到一个图形中；那么，`与门电路` 就是这样的，如下所示：

![与门电路](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-15-22.gif)

* ③ 可以将电路的 `连通` 使用数字 `1` 表示，电路的 `断开` 使用数字 `0` 那么，`与门电路` 就是这样的，如下所示：

![与门电路](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-15-24.gif)

* ④ `位与` 运算就类似数学中的 `交集`，如下所示：

![交集](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-15-27.svg)

### 6.3.3 应用示例

* 示例：`9 & 7 = 1`

![9 & 7 = 1](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-15-29.svg)



* 示例：`-9 & 7 = 7`

![-9 & 7 = 7](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-15-31.svg)
...
![或门电路](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-15-34.gif)

* ② 如果将 `开关` 的 `连通` 和 `断开` 称为 `输入端`，而 `灯泡` 的 `连通`（亮）和 `断开`（暗）称为 `输出端`，并将整个电路都封装到一个图形中；那么，`或门电路` 就是这样的，如下所示：

![或门电路](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-15-36.gif)

* ③ 可以将电路的 `连通` 使用数字 `1` 表示，电路的 `断开` 使用数字 `0` 表示；那么，`或门电路` 就是这样的，如下所示：

![或门电路](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-15-40.gif)

* ④ `位或` 运算就类似数学中的 `并集`，如下所示：

![并集](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-15-42.svg)

### 6.4.3 应用示例

* 示例：`9 | 7 = 15`

![9 | 7 = 15](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-15-46.svg)



* 示例：`-9 | 7 = -9`

![-9 | 7 = -9](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-15-47.svg)
...
![异或门电路](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-15-50.gif)

* ② 如果将 `开关` 的 `连通` 和 `断开` 称为 `输入端`，而 `灯泡` 的 `连通`（亮）和 `断开`（暗）称为 `输出端`，并将整个电路都封装到一个图形中；那么，`异或门电路` 就是这样的，如下所示：

![异或门电路](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-15-51.gif)

* ③ 可以将电路的 `连通` 使用数字 `1` 表示，电路的 `断开` 使用数字 `0` 表示；那么，`异或门电路` 就是这样的，如下所示：

![异或门电路](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-15-53.gif)

* ④ `位或` 运算就类似数学中的 `差集`，如下所示：

![差集](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-15-55.svg)

### 6.5.3 应用示例

* 示例：`9 ^ 7 = 14`

![9 ^ 7 = 14](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-15-58.svg)



* 示例：`-9 ^ 7 = -16`

![-9 ^ 7 = -16](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-15-59.svg)
...
![~9 = -10](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-16-03.svg)



* 示例：`~-9 = 8`

![~-9 = 8](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-16-06.svg)
...
![3 << 4 = 48](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-16-08.svg)



* 示例：`-3 << 4 = -48` （-3 × 2 ^4）

![-3 << 4 = -48](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-16-10.svg)
...
![69 >> 4 = 4](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-16-14.svg)



* 示例：`-69 >> 4 = -5` （-69 ÷ 2^4 ）

![-69 >> 4 = -5](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-16-16.svg)
...
![1101 0010 ^ 0 = 1101 0010](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-16-19.svg)
...
![1101 0010 ^ 1101 0010 = 0000 0000](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-16-21.svg)
...
![1101 0010 ^ 1001 1010 = 0100 1000](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-16-23.svg)



* 示例：`1001 1010 ^ 1101 0010 = 0100 1000`

![1001 1010 ^ 1101 0010 = 0100 1000](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-16-25.svg)
...
![1101 0010 ^ 0100 1000 ^ 1011 0010 = 0010 1000](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-16-28.svg)



* 示例：`0100 1000 ^ 1011 0010 ^ 1101 0010  = 0010 1000`

![0100 1000 ^ 1011 0010 ^ 1101 0010  = 0010 1000](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-16-29.svg)
...
![1011 0111 ^ 0101 1000 ^ 0101 1000 =  1011 0111](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-16-32.svg)
