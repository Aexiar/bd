...
![`字符集`和 `字符集编码` 之间的关系](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-21-04.png)

* Linux 中安装帮助手册：

![Linux 中安装帮助手册](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-21-09.gif)

## 1.2 ASCII 编码

* 从 `冯·诺依曼` 体系结构中，我们知道，计算机中所有的 `数据` 和 `指令` 都是以 `二进制` 的形式表示的；所以，计算机中对于文本数据的数据也是以二进制来存储的，那么对应的流程如下：

![编码和解码](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-21-06.png)
...
![Linux 查看 ascii 码表](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-21-14.gif)

* 其对应的 ASCII 编码表，如下所示：

![ASCII 编码表](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-21-16.gif)

* 但是，随着计算机的发展，计算机开始了东征之路，由美国传播到东方：

![计算机传播之路](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-21-18.png)
...
![](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-21-21.gif)

![](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-21-23.gif)
...
![Linux 查看 Unicode ](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-21-26.gif)
...
![`Unicode 字符集`和对应的`UTF-8 字符编码`之间的关系](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-21-28.png)
...
![查看 WSL2 的 Linux 发行版的默认编码](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-21-31.gif)
...
![搜索中文语言包](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-21-34.gif)
...
![安装中文语言包](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-21-36.gif)
...
![切换语言环境为中文](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-21-39.gif)
...
![手动加载配置文件，使其生效](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-21-42.gif)
...
![安装中文语言包](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-21-44.gif)
...
![切换环境为中文](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-21-49.gif)
...
![手动加载配置文件，使其生效](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-21-46.gif)
...
![](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-21-56.png)

* 并且，`文本` 是由 `数字`、`字母` 和 `汉字` 组成，如下所示：

![](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-21-58.png)
...
![](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-22-00.jpg)
...
> ::: details 点我查看 分辨率
>
> ![](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-22-02.png)
>
> :::
>
...
> ::: details 点我查看 像素
>
> ![](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-22-05.png)
>
> :::
>
...
> ::: details 点我查看 三原色
>
> ![](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-22-06.png)
>
> :::
...
![](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-22-10.jpg)
...
![](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-22-11.jpg)

* 应用场景：灰度图像在图像处理、计算机视觉和医学影像中有广泛应用，它能够保留较多的亮度信息，但不包含色彩（色相）信息。

![](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-22-13.jpg)

### 3.3.4 彩色图

- 定义：彩色图像是指图像中每个像素包含了 `红色（R）`、`绿色（G）` 和 `蓝色（B）` 的颜色信息，这三种颜色的不同组合形成了丰富的色彩。这通常使用 `RGB 颜色模型` 来表示每个像素的颜色信息，如下所示：

![](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-22-16.png)

- 用途：彩色图像应用广泛，几乎所有的日常照片、视频以及大部分的图形设计都使用彩色图像。它能够传达更多的信息和情感，因为人类视觉系统对颜色的感知非常敏感。

![](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-22-20.png)

## 3.4 计算机中声音数据的存储

* 计算机中 `声音` 数据的存储一般通过将 `声音信号` 数字化并以 `数字` 形式保存，如下所示：

![](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-22-18.png)
...
![Windows 7 操作系统（简体中文）默认控制台编码](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-22-25.png)

![Windows 7 操作系统（简体中文）默认文件编码](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-22-43.png)

* 但是，随着时间的推移，硬件的性能越来越强大，由于历史遗留问题，Windows 的内核依然是 UTF-16 编码；但是，控制台虽然依然是 GBK 编码，文件编码却早已改为了 UTF-8 编码，如下所示：

![Windows 11 操作系统（简体中文）默认控制台编码](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-22-27.png)

![Windows 11 操作系统（简体中文）默认文件编码](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-22-29.png)

### 4.2.2 Linux

* Linux 默认就是 `UTF-8` 编码，如下所示：

![Linux 系统的默认编码](https://github-pic.oss-cn-hangzhou.aliyuncs.com/java/2026-09-05/2026-09-05-19-22-33.png)
