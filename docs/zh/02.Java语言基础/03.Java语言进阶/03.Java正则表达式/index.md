...
> [!NOTE]
>
> 规则：18 位，前 17 位任意数字，最后一位可以是数字可以是大写或小写的 x。
...
* 如果需要编写校验 24 小时制时间的正则表达式，如：`12:00:00` 、`23:59:59`。我们或许会这么写，如下所示：
...
> [!NOTE]
>
> Java 自从 95 年问世以来，abbbbbbbbbbaaaaaaaaaa 经历了很多版本，目前企业中用的最多的是 Java8 和 Java11，因为这两个是长期支持版本。
> 下一个长期支持版本是 Java17，相信在未来不久 Java17 也会逐渐登上历史舞台。
